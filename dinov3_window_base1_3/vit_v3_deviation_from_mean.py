"""
Backbone V3: deviation from mean window representative token.
...
from .rep_selection.selectors import select_v3_deviation_from_mean
...
class WindowSelfAttentionWithGlobalV3(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int = 8,
    ...
    def forward(
        ...
        *,
        ...
        rep_dict = select_v3_deviation_from_mean(
            X_pre, X_post,
...
class LocalGlobalBlockV3(nn.Module):
    def __init__(
        self,
        *,
        dim: int,
        ...
        self.local_attn = WindowSelfAttentionWithGlobalV3(
            dim,
            num_heads=num_heads,
...
class LocalGlobalHybridVisionTransformerV3(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
        ...
        **ignored_kwargs,
        ...
        print(f"V3 (deviation_from_mean) window_size={window_size} selector={selector_space}/{gather_space}")
...
__all__ = ["LocalGlobalHybridVisionTransformerV3"]

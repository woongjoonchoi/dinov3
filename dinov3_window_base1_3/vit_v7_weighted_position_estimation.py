"""
Backbone V7: weighted position estimation window representative token.
...
from .rep_selection.selectors import select_v7_weighted_position_estimation
...
class WindowSelfAttentionWithGlobalV7(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int = 8,
    ...
    def forward(
        ...
        *,
        ...
        rep_dict = select_v7_weighted_position_estimation(
            X_pre, X_post,
...
class LocalGlobalBlockV7(nn.Module):
    def __init__(
        self,
        *,
        dim: int,
        ...
        self.local_attn = WindowSelfAttentionWithGlobalV7(
            dim,
            num_heads=num_heads,
...
class LocalGlobalHybridVisionTransformerV7(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
        ...
        **ignored_kwargs,
        ...
        print(f"V7 (weighted_position_estimation) window_size={window_size} selector={selector_space}/{gather_space}")
        norm_layer_cls = norm_layer_dict[norm_layer]
        selector_kwargs = {"tau": tau, "score_type": score_type}
...
__all__ = ["LocalGlobalHybridVisionTransformerV7"]

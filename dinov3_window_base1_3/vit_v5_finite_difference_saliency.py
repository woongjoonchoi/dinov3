"""
Backbone V5: finite difference saliency window representative token.
...
from .rep_selection.selectors import select_v5_finite_difference_saliency
...
class WindowSelfAttentionWithGlobalV5(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int = 8,
    ...
    def forward(
        ...
        *,
        ...
        rep_dict = select_v5_finite_difference_saliency(
            X_pre, X_post,
...
class LocalGlobalBlockV5(nn.Module):
    def __init__(
        self,
        *,
        dim: int,
        ...
        self.local_attn = WindowSelfAttentionWithGlobalV5(
            dim,
            num_heads=num_heads,
...
class LocalGlobalHybridVisionTransformerV5(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
        ...
        **ignored_kwargs,
        ...
        print(f"V5 (finite_difference_saliency) window_size={window_size} selector={selector_space}/{gather_space}")
...
__all__ = ["LocalGlobalHybridVisionTransformerV5"]

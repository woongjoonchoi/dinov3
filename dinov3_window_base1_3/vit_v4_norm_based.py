"""
Backbone V4: norm based window representative token.
...
from .rep_selection.selectors import select_v4_norm_based
...
class WindowSelfAttentionWithGlobalV4(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int = 8,
...
class LocalGlobalBlockV4(nn.Module):
    def __init__(
        self,
        *,
        dim: int,
        ...
        self.local_attn = WindowSelfAttentionWithGlobalV4(
            dim,
            num_heads=num_heads,
...
class LocalGlobalHybridVisionTransformerV4(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
        ...
        **ignored_kwargs,
        ...
        print(f"V4 (norm_based) window_size={window_size} selector={selector_space}/{gather_space}")
...
__all__ = ["LocalGlobalHybridVisionTransformerV4"]

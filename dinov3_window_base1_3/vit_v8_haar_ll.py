"""
Backbone V8: haar ll window representative token.
...
from .rep_selection.selectors import select_v8_haar_ll
...
class WindowSelfAttentionWithGlobalV8(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int = 8,
...
class LocalGlobalBlockV8(nn.Module):
    def __init__(
        self,
        *,
        dim: int,
        ...
        self.local_attn = WindowSelfAttentionWithGlobalV8(
            dim,
            num_heads=num_heads,
...
class LocalGlobalHybridVisionTransformerV8(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
        ...
        **ignored_kwargs,
        ...
        print(f"V8 (haar_ll) window_size={window_size} selector={selector_space}/{gather_space}")
...
__all__ = ["LocalGlobalHybridVisionTransformerV8"]

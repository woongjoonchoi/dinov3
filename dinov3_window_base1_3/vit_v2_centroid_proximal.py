"""
Backbone V2: centroid proximal window representative token.
...
from .rep_selection.selectors import select_v2_centroid_proximal
...
class WindowSelfAttentionWithGlobalV2(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int = 8,
    ...
    def forward(
        ...
        *,
        ...
        rep_dict = select_v2_centroid_proximal(
            X_pre, X_post,
...
class LocalGlobalBlockV2(nn.Module):
    def __init__(
        self,
        *,
        dim: int,
        ...
        self.local_attn = WindowSelfAttentionWithGlobalV2(
            dim,
            num_heads=num_heads,
...
class LocalGlobalHybridVisionTransformerV2(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
        ...
        **ignored_kwargs,
        ...
        print(f"V2 (centroid_proximal) window_size={window_size} selector={selector_space}/{gather_space}")
...
__all__ = ["LocalGlobalHybridVisionTransformerV2"]

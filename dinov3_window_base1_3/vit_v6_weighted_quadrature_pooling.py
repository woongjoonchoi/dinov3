"""
Backbone V6: weighted quadrature pooling window representative token.
...
from .rep_selection.selectors import select_v6_weighted_quadrature_pooling
...
class WindowSelfAttentionWithGlobalV6(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int = 8,
    ...
    def forward(
        ...
        *,
        ...
        rep_dict = select_v6_weighted_quadrature_pooling(
            X_pre, X_post,
...
class LocalGlobalBlockV6(nn.Module):
    def __init__(
        self,
        *,
        dim: int,
        ...
        self.local_attn = WindowSelfAttentionWithGlobalV6(
            dim,
            num_heads=num_heads,
...
class LocalGlobalHybridVisionTransformerV6(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
        ...
        **ignored_kwargs,
        ...
        print(f"V6 (weighted_quadrature_pooling) window_size={window_size} selector={selector_space}/{gather_space}")
...
__all__ = ["LocalGlobalHybridVisionTransformerV6"]

"""
Backbone V9: entropy based window representative token.
...
from .rep_selection.selectors import select_v9_entropy_based
...
class WindowSelfAttentionWithGlobalV9(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int = 8,
    ...
    def forward(
        ...
        *,
        ...
        rep_dict = select_v9_entropy_based(
            X_pre, X_post,
...
class LocalGlobalBlockV9(nn.Module):
    def __init__(
        self,
        *,
        dim: int,
        ...
        self.local_attn = WindowSelfAttentionWithGlobalV9(
            dim,
            num_heads=num_heads,
...
class LocalGlobalHybridVisionTransformerV9(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 224,
        ...
        **ignored_kwargs,
        ...
        print(f"V9 (entropy_based) window_size={window_size} selector={selector_space}/{gather_space}")
        norm_layer_cls = norm_layer_dict[norm_layer]
        selector_kwargs = {"tau_c": tau_c, "entropy_mode": entropy_mode}
...
__all__ = ["LocalGlobalHybridVisionTransformerV9"]

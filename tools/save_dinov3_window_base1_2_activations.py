"""Extract DinoV3 Baseline1_2 backbone activations and save them per image/class.

This script mirrors ``tools/save_backbone_activations.py`` but targets the
``DinoVisionTransformerWindowLastGlobal`` hybrid backbone. For each image in an
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=json.loads,
        default={},
        help="JSON object of keyword arguments forwarded to DinoVisionTransformerWindowLastGlobal.",
    )

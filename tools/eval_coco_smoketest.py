...
from dinov3_window_base1_3.vit_v1_mean_centroid import LocalGlobalHybridVisionTransformerV1
from dinov3_window_base1_3.vit_v2_centroid_proximal import LocalGlobalHybridVisionTransformerV2
from dinov3_window_base1_3.vit_v3_deviation_from_mean import LocalGlobalHybridVisionTransformerV3
from dinov3_window_base1_3.vit_v4_norm_based import LocalGlobalHybridVisionTransformerV4
from dinov3_window_base1_3.vit_v5_finite_difference_saliency import LocalGlobalHybridVisionTransformerV5
from dinov3_window_base1_3.vit_v6_weighted_quadrature_pooling import LocalGlobalHybridVisionTransformerV6
from dinov3_window_base1_3.vit_v7_weighted_position_estimation import LocalGlobalHybridVisionTransformerV7
from dinov3_window_base1_3.vit_v8_haar_ll import LocalGlobalHybridVisionTransformerV8
from dinov3_window_base1_3.vit_v9_entropy_based import LocalGlobalHybridVisionTransformerV9
    ...
    **kwargs,
    ...
    if backbone is None:
        backbone_class_map = {
            ...
            # ── V1: mean_centroid (4 space combos) ────────────────────────────
            "b1_3_mean_centroid_pre_pre": partial(LocalGlobalHybridVisionTransformerV1, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_mean_centroid_post_post": partial(LocalGlobalHybridVisionTransformerV1, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_mean_centroid_pre_post": partial(LocalGlobalHybridVisionTransformerV1, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_mean_centroid_post_pre": partial(LocalGlobalHybridVisionTransformerV1, selector_space="post_ln", gather_space="pre_ln", window_size=16),
            # ── V2: centroid_proximal ──────────────────────────────────────────
            "b1_3_centroid_proximal_pre_pre": partial(LocalGlobalHybridVisionTransformerV2, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_centroid_proximal_post_post": partial(LocalGlobalHybridVisionTransformerV2, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_centroid_proximal_pre_post": partial(LocalGlobalHybridVisionTransformerV2, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_centroid_proximal_post_pre": partial(LocalGlobalHybridVisionTransformerV2, selector_space="post_ln", gather_space="pre_ln", window_size=16),
            # ── V3: deviation_from_mean ────────────────────────────────────────
            "b1_3_deviation_from_mean_pre_pre": partial(LocalGlobalHybridVisionTransformerV3, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_deviation_from_mean_post_post": partial(LocalGlobalHybridVisionTransformerV3, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_deviation_from_mean_pre_post": partial(LocalGlobalHybridVisionTransformerV3, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_deviation_from_mean_post_pre": partial(LocalGlobalHybridVisionTransformerV3, selector_space="post_ln", gather_space="pre_ln", window_size=16),
            # ── V4: norm_based ─────────────────────────────────────────────────
            "b1_3_norm_based_pre_pre": partial(LocalGlobalHybridVisionTransformerV4, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_norm_based_post_post": partial(LocalGlobalHybridVisionTransformerV4, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_norm_based_pre_post": partial(LocalGlobalHybridVisionTransformerV4, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_norm_based_post_pre": partial(LocalGlobalHybridVisionTransformerV4, selector_space="post_ln", gather_space="pre_ln", window_size=16),
            # ── V5: finite_difference_saliency ────────────────────────────────
            "b1_3_finite_difference_saliency_pre_pre": partial(LocalGlobalHybridVisionTransformerV5, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_finite_difference_saliency_post_post": partial(LocalGlobalHybridVisionTransformerV5, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_finite_difference_saliency_pre_post": partial(LocalGlobalHybridVisionTransformerV5, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_finite_difference_saliency_post_pre": partial(LocalGlobalHybridVisionTransformerV5, selector_space="post_ln", gather_space="pre_ln", window_size=16),
            # ── V6: weighted_quadrature_pooling ───────────────────────────────
            "b1_3_weighted_quadrature_pooling_pre_pre": partial(LocalGlobalHybridVisionTransformerV6, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_weighted_quadrature_pooling_post_post": partial(LocalGlobalHybridVisionTransformerV6, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_weighted_quadrature_pooling_pre_post": partial(LocalGlobalHybridVisionTransformerV6, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_weighted_quadrature_pooling_post_pre": partial(LocalGlobalHybridVisionTransformerV6, selector_space="post_ln", gather_space="pre_ln", window_size=16),
            # ── V7: weighted_position_estimation ──────────────────────────────
            "b1_3_weighted_position_estimation_pre_pre": partial(LocalGlobalHybridVisionTransformerV7, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_weighted_position_estimation_post_post": partial(LocalGlobalHybridVisionTransformerV7, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_weighted_position_estimation_pre_post": partial(LocalGlobalHybridVisionTransformerV7, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_weighted_position_estimation_post_pre": partial(LocalGlobalHybridVisionTransformerV7, selector_space="post_ln", gather_space="pre_ln", window_size=16),
            # ── V8: haar_ll ────────────────────────────────────────────────────
            "b1_3_haar_ll_pre_pre": partial(LocalGlobalHybridVisionTransformerV8, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_haar_ll_post_post": partial(LocalGlobalHybridVisionTransformerV8, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_haar_ll_pre_post": partial(LocalGlobalHybridVisionTransformerV8, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_haar_ll_post_pre": partial(LocalGlobalHybridVisionTransformerV8, selector_space="post_ln", gather_space="pre_ln", window_size=16),
            # ── V9: entropy_based ──────────────────────────────────────────────
            "b1_3_entropy_based_pre_pre": partial(LocalGlobalHybridVisionTransformerV9, selector_space="pre_ln", gather_space="pre_ln", window_size=16),
            "b1_3_entropy_based_post_post": partial(LocalGlobalHybridVisionTransformerV9, selector_space="post_ln", gather_space="post_ln", window_size=16),
            "b1_3_entropy_based_pre_post": partial(LocalGlobalHybridVisionTransformerV9, selector_space="pre_ln", gather_space="post_ln", window_size=16),
            "b1_3_entropy_based_post_pre": partial(LocalGlobalHybridVisionTransformerV9, selector_space="post_ln", gather_space="pre_ln", window_size=16),
        }

"""Run ImageNet-style inference with the Baseline1_3 local+global backbone using DDP."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--backbone-checkpoint", type=pathlib.Path, required=True, help="Checkpoint containing LocalGlobalHybridVisionTransformer weights.")
    ...
    parser.add_argument(
        ...
        type=json.loads,
        default={},
        help="JSON object of keyword arguments forwarded to LocalGlobalHybridVisionTransformer (e.g. '{\"embed_dim\": 1024}')",
    )
